...
++counter;});});function toggleLogoImg(id){var img=document.getElementById(id).src;if(img.indexOf('dark.png')!=-1){document.getElementById(id).src="https://www.jessicajorgenson.site/images/logo.png";}
else{document.getElementById(id).src="https://www.jessicajorgenson.site/images/logo-dark.png";}}
